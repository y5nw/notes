...
\texttt{javac} Übersetzt Quellcode in Klassen. \texttt{java} führt das Programm aus. Dabei wird in der Klasse die Methode \texttt{main}\index[java]{\texttt{main}} gestartet.
...
Klasse\index{Java!Klasse}: „Bauplan“ von Objekten. Sie legen fest, welche Attribute und Methoden die Objekt-Instanzen\index{Java!Objekt!Instanz} der Klassen haben können.
